  ...
  const metrics: Metric[] = [
    {
      ...
      format: 'currency',
      icon: <CurrencyDollarIcon className="w-5 h-5 text-neutral-300" />,
    ...
    },
    {
      ...
      format: 'percent',
      icon: <ChartBarIcon className="w-5 h-5 text-neutral-400" />,
      variant: 'primary',
    },
    {
      label: 'Sharpe Ratio',
      ...
      format: 'number',
      icon: <ArrowTrendingUpIcon className="w-5 h-5 text-neutral-500" />,
      variant: 'default',
    },
    {
      label: 'Max Drawdown',
      ...
      format: 'percent',
      icon: <ShieldExclamationIcon className="w-5 h-5 text-neutral-600" />,
      variant: 'loss',
    },
  ]
