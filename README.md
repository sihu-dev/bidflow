...
**최적화 기법:**
- **Prompt Caching**: System prompt 재사용 (90% 절감)
- **Effort Parameter**: 입찰 금액별 차등 분석 (76% 토큰 절감)
- **Batch API**: 저가 입찰 야간 처리 (50% 비용 절감)
- **웹 검색 캐싱**: 중복 검색 방지

**월간 가정**: 100건 입찰 분석 (저가 50건, 중가 30건, 고액 20건)

📊 자세한 비용 분석: [AI_COST_OPTIMIZATION.md](.forge/AI_COST_OPTIMIZATION.md)
